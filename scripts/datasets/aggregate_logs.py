...
from libs.flatten import flatten_core_blocks, flatten_phase_metrics, flatten_diag_by_phase
...
def main():
    ...
    for p in files:
        try:
            ...
            if row_passes_filters(row, club=args.club, phase_method=args.phase_method, since=since, until=until):
                rows.append(row)
